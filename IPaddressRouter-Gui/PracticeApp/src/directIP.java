class directIP{
    ...
    private static int fullAddress = 0;
    private static char[] binaryIP = new char[32];  // binary representation of input IP address
    private static char[] bitSelect = new char[32]; // decided bits to use based on input IP for binary AND with binaryIP value
    private static String binaryAndResult;


    private static String matchedIP;
    private static String[] ipAddressMask = {
